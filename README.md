This project is a simple web application that lists employee absences. It fetches data from the provided fake endpoints and displays it in an organized manner. The application has several key features:
